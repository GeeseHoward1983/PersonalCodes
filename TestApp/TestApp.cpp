...
{
    unsigned char teaKey[] = "Calamity_Fortune";
    _DWORD v47[4];
    v47[0] = 0x12345678;
    v47[1] = 0x9ABCDEF0;
    v47[2] = 0xFEDCBA98;
    ...
    _DWORD v50[11] = { 0 };
    memcpy(v50, v7, 44);
    unsigned int v16 = 0xCC623AF3;
    _DWORD v15 = v50[10];
    for (int i = 0; i < 10; i++)
    {
        v16 -= 0x9E3779B9;
        printf("v16:%08X\n", v16);
        _DWORD v17 = *((_DWORD*)v47 + (((unsigned __int8)(v16 >> 2) ^ 0x0A) & 3));
        printf("v17:%08X\n", v17);
        v15 = v50[10] - ((((v50[9] >> 5) ^ (4 * v50[0])) + ((16 * v50[9]) ^ (v50[0] >> 3))) ^ ((v50[0] ^ v16) + ((v17 ^ v50[9]))));
        v50[10] = v15;
        printf("v15:%08X\n", v15);
        for (int k = 9; k > 0; k--)
        {
            v15 = v50[k] - (((v50[k - 1] ^ *((_DWORD*)v47 + (((unsigned __int8)(v16 >> 2) ^ (unsigned __int8)(k)) & 3))) + (v50[k + 1] ^ v16)) ^ (((4 * v50[k + 1]) ^ (v50[k - 1] >> 5)) + ((16 * v50[k - 1]) ^ (v50[k + 1] >> 3))));
            printf("v15:%08X\n", v15);
            v50[k] = v15;
        }
        v50[0] = v50[0] - (((v50[10] ^ *((_DWORD*)v47 + (((unsigned __int8)(v16 >> 2) ^ (unsigned __int8)(0)) & 3))) + (v50[1] ^ v16)) ^ (((4 * v50[1]) ^ (v50[10] >> 5)) + ((16 * v50[10]) ^ (v50[1] >> 3))));
        printf("v15:%08X\n", v50[0]);
        v15 = v50[10];
        unsigned char* p = (unsigned char*)v50;
        for (int j = 0; j < 44; j++)
        {
            printf("%02X ", p[j]);
        }
